...
//FUNCION PRINCIPAL DONDE OBTENEMOS LOS PROCESOS 
async function procesarLote(conn, totals) {
    ...
    for (const row of rows) {
        ...
        // FILTRO DE EJECUITAR == ASIGNACIONES O ESTADO , GUARDAMOS EN ARRAY PARA SABER LOS QUE VAMOS A PROCESAR 
    ...
    // PRELOAD ESTADO ANTERIOR PARA LOS ID 
    let prevStateMap;
    {
        const t = nowMs();
