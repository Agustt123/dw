...
async function sincronizar100PorEmpresa(didOwner) {
    console.log(`🔄 Sincronizando hasta 100 registros por tabla para empresa ${didOwner}`);
    ...
    try {
        ...
        console.log(`✅ Sincronización parcial completada para empresa ${didOwner}`);
    } catch (error) {
